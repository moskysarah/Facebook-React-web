...
function MarketPlace() {
    ...
    return (
        ...
        <div className="grid grid-cols-3 gap-2 shadow-lg p-4  rounded-lg   justify-center">
            
            <div className="shadow-lg p-4 bg-[#242526] rounded-lg w-65 h-[27rem] border-1 border-gray-500">
                <img src="/profil/9a14c86e49dcb14c37584a9cb3d50187.jpg" alt=""
                   className="rounded-t-lg w-[34rem] h-75 object-cover "
